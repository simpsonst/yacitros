...
#ifndef Yacitros_vdu_gfx
#define Yacitros_vdu_gfx
...
#include "../../yacitros/common.h"
  ...
  Yacitros_USERESULT
  _kernel_oserror *vdu_plot(int, vdu_ord, vdu_ord);
  Yacitros_USERESULT
  _kernel_oserror *vdu_setecforigin(vdu_ord x, vdu_ord y);
  Yacitros_USERESULT
  _kernel_oserror *vdu_readpoint(vdu_ord x, vdu_ord y,
                                 vdu_gcol *r, int *i);

#if false
  /* these call through the VDU stream; I want something direct */
  Yacitros_USERESULT
